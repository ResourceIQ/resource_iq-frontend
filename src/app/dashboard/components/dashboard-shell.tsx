        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-neutral-500 font-medium">
              Here's what's happening across your resources today.
            </p>
          </div>
          ...
          <Card className="xl:col-span-2 border-none shadow-sm ring-1 ring-neutral-200 dark:ring-neutral-800 overflow-hidden">
            <CardHeader className="flex flex-row items-center justify-between pb-4">
              <div>
                ...
                <CardDescription>
                  Real-time updates from integrated repositories
                </CardDescription>
              </div>
              <Button
                variant="ghost"
            ...
            <CardContent className="p-0 border-t">
              <div className="divide-y divide-neutral-100 dark:divide-neutral-800">
                {Object.values(prs).flat().length > 0 ? (
                  Object.entries(prs)
                    .slice(0, 5)
                    .map(([author, activities]: [string, any], i) => (
                      <div
                        key={i}
                        className="p-4 hover:bg-neutral-50 dark:hover:bg-neutral-800/20 transition-colors"
                      >
                  ...
                  <div className="p-10 flex flex-col items-center justify-center text-center space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-500">
                        Connect your GitHub app to see live insights.
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="space-y-6">
            <Card className="border-none shadow-sm ring-1 ring-neutral-200 dark:ring-neutral-800">
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  variant="outline"
                  className="w-full mt-2 rounded-xl border-dashed"
                >
                  Manage Team
                </Button>
              </CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-primary-foreground/80 leading-snug">
                      Generate smart resource allocation reports using our new
                      AI module.
                    </p>
                  </div>
                  <Button
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm uppercase tracking-wider font-bold antialiased text-[11px]">
          {label}
        </span>
      </div>
      {count !== undefined && (
