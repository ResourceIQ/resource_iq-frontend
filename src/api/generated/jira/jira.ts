 ...
 */
export type jiraGetOpenIssuesResponse200 = {
  data: JiraOpenIssue[]
  status: 200
}

export type jiraGetOpenIssuesResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type jiraGetOpenIssuesResponseSuccess = (jiraGetOpenIssuesResponse200) & {
  headers: Headers;
};
export type jiraGetOpenIssuesResponseError = (jiraGetOpenIssuesResponse422) & {
  headers: Headers;
};

export type jiraGetOpenIssuesResponse = (jiraGetOpenIssuesResponseSuccess | jiraGetOpenIssuesResponseError)

export const getJiraGetOpenIssuesUrl = (params?: JiraGetOpenIssuesParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/v1/jira/issues/open?${stringifiedParams}` : `/api/v1/jira/issues/open`
}

export const jiraGetOpenIssues = async (params?: JiraGetOpenIssuesParams, options?: RequestInit): Promise<jiraGetOpenIssuesResponse> => {
  
  return customFetch<jiraGetOpenIssuesResponse>(getJiraGetOpenIssuesUrl(params),
  {      
    ...options,
    method: 'GET'
...
export const getJiraGetOpenIssuesQueryKey = (params?: JiraGetOpenIssuesParams,) => {
    return [
    `/api/v1/jira/issues/open`, ...(params ? [params] : [])
    ] as const;
    }

    
export const getJiraGetOpenIssuesQueryOptions = <TData = Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError = HTTPValidationError>(params?: JiraGetOpenIssuesParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getJiraGetOpenIssuesQueryKey(params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof jiraGetOpenIssues>>> = ({ signal }) => jiraGetOpenIssues(params, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type JiraGetOpenIssuesQueryResult = NonNullable<Awaited<ReturnType<typeof jiraGetOpenIssues>>>
export type JiraGetOpenIssuesQueryError = HTTPValidationError


export function useJiraGetOpenIssues<TData = Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError = HTTPValidationError>(
 params: undefined |  JiraGetOpenIssuesParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof jiraGetOpenIssues>>,
          TError,
          Awaited<ReturnType<typeof jiraGetOpenIssues>>
        > , 'initialData'
      >, request?: SecondParameter<typeof customFetch>}
...
export function useJiraGetOpenIssues<TData = Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError = HTTPValidationError>(
 params?: JiraGetOpenIssuesParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError, TData>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof jiraGetOpenIssues>>,
          TError,
          Awaited<ReturnType<typeof jiraGetOpenIssues>>
...
export function useJiraGetOpenIssues<TData = Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError = HTTPValidationError>(
 params?: JiraGetOpenIssuesParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get Open Issues
...
export function useJiraGetOpenIssues<TData = Awaited<ReturnType<typeof jiraGetOpenIssues>>, TError = HTTPValidationError>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getJiraGetOpenIssuesQueryOptions(params,options)
